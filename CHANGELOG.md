...
- [PR#190](https://github.com/DmitryTsepelev/rubocop-graphql/pull/190) Add `GraphQL/DisallowedTypes` cop: flags field and argument types the project has configured as disallowed, with a message explaining what to use instead; `Float` is disallowed by default ([@corsonknowles][])
